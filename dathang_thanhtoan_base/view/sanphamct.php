                ...
                <div class="left-ads-display col-lg-8">
                    <div class="row">
                        <div class="desc1-left col-md-6">
                            <img src="./uploads/<?php echo $kq[0]['img'] ?>" class="img-fluid" alt="">
                        </div>
                        <div class="desc1-right col-md-6 pl-lg-4">
                            <h3><?php echo $kq[0]['tensp'] ?></h3>
                            <h5>Rs. <?php echo $kq[0]['gia'] ?> <span>599</span></h5>
                            <div class="available mt-3">
                                <form action="index.php?act=addcart" method="post" class="w3layouts-newsletter">
                                    <input type="number" name="sl" value="1" min=1 max=50 required="">
                                    <!-- <button class="btn1">Ddawtj</button> -->
                                    <input class="btn1" type="submit" value="Đặt hàng" name="addtocart">
                                    <!-- input hidden here -->
                                    <input type="hidden" value="<?php echo $kq[0]['id'] ?>" name="id">
                                    <input type="hidden" value="<?php echo $kq[0]['tensp'] ?>" name="tensp">
                                    <input type="hidden" value="<?php echo $kq[0]['img'] ?>" name="img">
                                    <input type="hidden" value="<?php echo $kq[0]['gia'] ?>" name="gia">
                                </form>
                                <span><a href="#">login to save in wishlist </a></span>
                                <p>Lorem Ipsum has been the industry's standard since the 1500s. Praesent ullamcorper
                                    dui turpis.. </p>
                            </div>
                    ...
                    <div class="row sub-para-w3layouts mt-5">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elPellentesque vehicula augue eget nisl
                            ...
                            enim ad minim veniam, quis nostrud exercitation ullamco. labore et dolore magna aliqua.</p>
                        <p class="mt-3 italic-blue">Consectetur adipisicing elPellentesque vehicula augue eget nisl
                            ullamcorper, molestie blandit ipsum auctor. Mauris volutpat augue dolor.Consectetur
                            adipisicing elit, sed do eiusmod tempor incididunt ut lab ore et dolore magna aliqua. Ut
                            enim ad minim veniam, quis nostrud exercitation ullamco. labore et dolore magna aliqua.</p>
                        <p class="mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elPellentesque vehicula
                            augue eget nisl ullamcorper, molestie blandit ipsum auctor. Mauris volutpat augue
                            dolor.Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut lab ore et dolore
