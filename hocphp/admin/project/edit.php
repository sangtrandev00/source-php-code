...
?>
    ...
    if (count($err) == 0 && isset($_POST['txtname'])) {
        ...
        $sql = "update project set name='$name',cateid='$cateid',description='$description',startdate='$startdate',enddate='$enddate',total='$total',image='$image',detail='$detailed_description' where id=" . $id;
        //echo $sql;
        $db->query($sql);
