...
function plusQty(n) {
    ...
    console.log(localStorage.getItem(currentDataId));
    JSON.parse(localStorage.getItem(currentDataId)).quantity = currentNumber;
    const currentRowItem = JSON.parse(localStorage.getItem(currentDataId));
    console.log(JSON.parse(localStorage.getItem(currentDataId)).quantity);

    const newProductObj = {
        ...currentRowItem,
        "quantity": currentNumber
    }
    localStorage.setItem(currentDataId, JSON.stringify(newProductObj));
    // localStorage.setItem()
    const currentQtyFromLocal = JSON.parse(localStorage.getItem(currentDataId)).quantity;

    quantity.innerText = currentQtyFromLocal;
    calcMoneyCart();
}
