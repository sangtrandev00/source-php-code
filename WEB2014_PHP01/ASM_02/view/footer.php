...
<div class="footer">
    <div class="grid wide">
        <div class="footer-top">
            <div class="footer-top__col footer-top__logo-wrap">
                <a href="" class="footer-top__col-title footer__logo">
                    <svg class="footer__logo-svg" width="108" height="46" viewBox="0 0 108 46" fill="none"
                ...
                <ul class="footer-top__col-list">
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">Home</a>
                    </li>
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">Shop</a>
                    </li>
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">About</a>
                    </li>
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">Forum</a>
                    </li>
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">Contact</a>
                    </li>
                </ul>
            </div>
            <div class="footer-top__col footer-top__logo-wrap">
                <a href="" class="footer-top__col-title">
                    Explore
                </a>
                <ul class="footer-top__col-list">
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">FAQ</a>
                    </li>
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">Shipping & Return</a>
                    </li>
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">Store Policy</a>
                    </li>
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">Payment Methods</a>
                    </li>
                </ul>
            </div>
            <div class="footer-top__col footer-top__logo-wrap">
                ...
                <input type="email" name="" id="" class="form-control footer__input-email"
            ...
            <div class="footer-top__col footer-top__logo-wrap">
                ...
                <ul class="footer-top__col-list">
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">Facebook
                            <i class="fa-brands fa-facebook"></i>
                        </a>
                    </li>
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">
                            Twitter
                            <i class="fa-brands fa-twitter"></i>
                        </a>
                    </li>
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">Instagram
                            <i class="fa-brands fa-instagram"></i>
                        </a>
                    </li>
                    <li class="footer-top__col-item">
                        <a href="" class="footer-top__col-link">Pinterest
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-bottom__col footer-bottom__copyright">
                <p>2022 All Right Reserve</p>
            </div>
            <div class="footer-bottom__col footer-bottom__payment-accept">
                <p class="payment-accept__title">We Accept</p>
                <div class="payment-list">
                    <img src="./assets/images/payment/visa.png" alt="" class="payment-img">
                    <img src="./assets/images/payment/paypal.png" alt="" class="payment-img">
                    <img src="./assets/images/payment/mastercard.png" alt="" class="payment-img">
                    <img src="./assets/images/payment/maestro.png" alt="" class="payment-img">
                    <img src="./assets/images/payment/american express.png" alt="" class="payment-img">
                    <img src="./assets/images/payment/bitcoin.png" alt="" class="payment-img">
                    <img src="./assets/images/payment/CB.png" alt="" class="payment-img">
                    <img src="./assets/images/payment/Dmca.png" alt="" class="payment-img">
                </div>
            </div>
        </div>
    </div>
...
<div id="modal">
    ...
    <div class="modal__container">
        <img src="./assets/images/modal-popup/modal-popup-sale-off-shoes.png" alt="modal-popup-sale-off-shoes"
            class="modal__banner">
        <a href="./shop-page-for-women.html" class="shop-btn modal__shop-btn">SHOP NOW</a>
        <i class="modal__exit-icon fa-solid fa-xmark"></i>
    </div>
</div>
...
<div class="pop-up display-none">
    ...
    <div class="pop-up__container">
        <p class="pop-up__success-text"><i class="pop-up__success-icon fa-regular fa-circle-check"></i>Product
            has been successfully
            added to your cart!</p>
        <div class="pop-up__product">
            <div class="pop-up__product-img-container">
                <img src="./assets/images/detail-product/for-men/model-with-short.png" alt=""
                    class="pop-up__product-img">
            </div>
            <div class="pop-up__desc">
                <h3 class="pop-up__desc-title">Demin Look Shorts</h3>
                <div class="pop-up__desc-color">
                    <span>Color: </span>
                    <span class="pop-up__desc-color-text">Dark Green</span>
                </div>
                <div class="pop-up__desc-size">
                    <span>Size: </span>
                    <span class="pop-up__desc-size-text">XL</span>
                </div>
                <div class="pop-up__desc-price">
                    <span>Price: </span>
                    <span class="pop-up__desc-price-text heading-font">$19</span>
                </div>
                <div class="pop-up__desc-qty">
                    <span>Qty: </span>
                    <span class="pop-up__desc-qty-text heading-font">2</span>
                </div>
                <div class="divider"></div>
                <div class="pop-up__desc-price-total d-flex space-between">
                    <span>Price: </span>
                    <span class="pop-up__desc-price-total-text heading-font">$28</span>
                </div>
                <div class="pop-up__desc-shipping-fee d-flex space-between">
                    <span>Shipping fee: </span>
                    <span class="pop-up__desc-shipping-fee-text heading-font">$5.5</span>
                </div>
                <div class="pop-up__desc-total-money d-flex space-between">
                    <span>Cart total: </span>
                    <span class="pop-up__desc-total-money-text heading-font">$33.5</span>
                </div>
            </div>
        </div>
        <i class="pop-up__container-close-icon fa-solid fa-xmark"></i>
        <div class="main-product__buttons pop-up__buttons">
            <button class="main-product__button main-product__button--wishlist pop-up__buttons--continue">
                Continue Shopping
            </button>
            <button class="main-product__button main-product__button--wishlist pop-up__buttons--checkout">
                Checkout
            </button>
            <button class="main-product__button main-product__button--addtocart pop-up__buttons--view-cart"
...
if (isset($_GET['act'])) {
    switch ($_GET['act']) {
        ...
        case 'detailpage':
            ...
            <script src="./assets/js/add-to-cart.js">
        ...
        case 'shoppingcartpage':
            ...
            <script src="./assets/js/shopping-cart.js">
        ...
        case 'signupsuccess':
          ...
          ';
            ...
            //     <!-- Homepage javascript -->
            //     <script type="module" src="./assets/js/home-page-js.js">
